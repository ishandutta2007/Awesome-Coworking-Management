...
## Top Coworking Management Tools Ecosystem

**Curated List of SaaS Products & Open-Source GitHub Projects**

*Focused on Membership Management, Desk & Room Booking, Billing, Access Control, Community Features & Space Operations*

**Last updated: August 2026**



This repository tracks notable **SaaS platforms** and **open-source projects** for **Coworking Management**. These tools help coworking operators, flexible workspace providers, and hybrid office managers handle memberships, hot-desks, private offices, meeting rooms, billing, access control, visitor management, and member community features.



**Examples** include Nexudus, OfficeRnD, Cobot, Optix, Yardi Kube, Satellite Deskworks, Essensys, Archie, Proximity Space, and Spacebring (the category leaders and widely used platforms).



**Open-source emphasis**: Fully featured open-source coworking management suites (memberships + billing + access + community in one package) remain relatively scarce. This section prioritizes the strongest available open-source desk/room booking systems, workspace reservation tools, and extensible platforms that operators can self-host and customize.
...
**Made for coworking operators, flexible workspace managers, hybrid workplace leads, and anyone who wants more transparent and controllable space management infrastructure.**

Let's make desk booking, membership operations, and flexible workspace software more open, affordable, and under operator control.
